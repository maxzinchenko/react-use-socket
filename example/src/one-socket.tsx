...
const Subscription = () => {
  const [data, { stop }]  = useSubscription<DeserializedRes>('get_user');
...
const LazySubscription = () => {
  const [data, { start, stop }]  = useLazySubscription<DeserializedRes>('get_user');
